...
<p align="center">
  ...
  Reads glucose from dozens of CGM apps, displays with interactive graph and alerts, pushes to Nightscout and Tidepool.
</p>

<p align="center">
  <a href="https://github.com/psjostrom/strimma/releases"><strong>Download</strong></a> · <a href="https://www.strimma.org/"><strong>Docs</strong></a> · <a href="https://www.strimma.org/getting-started/setup/"><strong>Setup Guide</strong></a>
</p>
...
- **Companion Mode** — reads glucose from your CGM app's notification. Works with Dexcom, Libre 2, CamAPS FX, Juggluco, xDrip+, Medtronic, Eversense, and many more.
...
A setup wizard walks you through permissions and data source configuration on first launch. See the [Setup Guide](https://www.strimma.org/getting-started/setup/) for details.
